...
import peopleImage from '../../../assets/admin/images/dashboard/people.svg';
const Dashboard = () => {
  return (
    <>
      <Helmet>
        <title>Dashboard</title>
        <meta name='sashboard' content='Beginner Dashboard.' />
      </Helmet>
      <Wrapper>
      <div className="main-panel">
            ...
            <footer className="footer">
              <div className="d-sm-flex justify-content-center justify-content-sm-between">
                <span className="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021.  Premium <Link to="/">Bootstrap admin template</Link> from BootstrapDash. All rights reserved.</span>
